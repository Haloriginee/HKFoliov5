        ...
        {projects.map(({id, title, des, img, iconLists, link}) => (
          <div key={id} className='sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem] flex items-center justify-center w-[80vw] sm:w-[570px] '>
            <PinContainer title={link} href={link}>
              <div className='relative flex items-center justify-center sm:w-[570px] sm:h-[40vh] h-[30] w-[80vw] overflow-hidden mb-10 '>
                <div className='relative w-full h-full overflow-hidden lg:rounded-3xl bg-[#13162d] '>
                  <img src='/bg.png' alt='img'/>
                </div>
                 <img src={img} alt={title} className='absolute bottom-0 z-10 h-full' />
              </div>
              ...
              <div className='flex items-center justify-between mt-7 mb-3'>
                ...
                <div className='flex justify-center items-center'>
                  <p className='flex lg:xt-xl md:text-xs text-sm text-purple'>
                    Live Site
                  </p>
